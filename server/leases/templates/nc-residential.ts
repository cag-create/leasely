...
<article class="lease-document" data-state="NC" data-tenancy="residential">
  ...
  <footer class="lease-footer">
    <p><em>Generated by Keycove. This document is a starting draft based on the cited North Carolina statutes and federal regulations. It is not a substitute for advice from a licensed North Carolina attorney.</em></p>
  </footer>
</article>`;
