...
<article class="lease-document" data-state="TN" data-tenancy="residential">
  ...
  <footer class="lease-footer">
    <p><em>Generated by Leasely. This document is a starting draft based on the cited Tennessee statutes and federal regulations. A licensed Tennessee attorney should review before reliance in litigation.</em></p>
  </footer>
</article>`;
