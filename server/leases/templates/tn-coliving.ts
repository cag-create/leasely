...
<article class="lease-document" data-state="TN" data-tenancy="coliving_membership">
  ...
  <footer class="lease-footer">
    <p><em>Generated by Leasely. The membership framing is for house-rules and room-assignment purposes only — it does not change the eviction procedure Operator must follow to remove a Member from possession. A licensed Tennessee attorney should review before reliance in litigation.</em></p>
  </footer>
</article>`;
