...
<article class="lease-document" data-state="NC" data-tenancy="coliving_membership">
  ...
  <footer class="lease-footer">
    <p><em>Generated by Keycove. The "membership" framing is for house-rules and room-assignment purposes only — it does not change the eviction procedure Operator must follow to remove a Member from possession. A licensed North Carolina attorney should review before reliance in litigation.</em></p>
  </footer>
</article>`;
