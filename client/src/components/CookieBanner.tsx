  ...
  return (
    ...
    >
      ...
      <p className="text-white/65 text-xs leading-relaxed mb-4">
        ...
        <Link href="/legal/cookies"><span className="text-[#00C896] hover:underline cursor-pointer">Cookie Policy</span></Link> and{" "}
        <Link href="/legal/privacy"><span className="text-[#00C896] hover:underline cursor-pointer">Privacy Policy</span></Link>.
      </p>
      <div className="flex flex-col sm:flex-row gap-2">
        <Button
          size="sm"
          onClick={() => recordChoice("all")}
          className="bg-[#00C896] hover:bg-[#00A87C] text-[#062018] font-semibold flex-1"
        >
          Accept all
        </Button>
        <Button
