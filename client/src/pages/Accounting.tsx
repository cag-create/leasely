...
export default function Accounting() {
  ...
  const exportPDF = () => {
    ...
    const html = `
      ...
      <html>
      <head>
        <title>Keycove Accounting Report ${selectedYear}</title>
        <style>
      ...
      <body>
        <h1>🏠 Keycove — Rental Accounting Report</h1>
        ...
        <div class="footer">Generated by Keycove Pro · keycove.net · For tax purposes, consult a qualified accountant.</div>
      </body>
      </html>
    `;
