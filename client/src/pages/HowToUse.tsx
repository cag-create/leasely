...
const STEPS: Step[] = [
  {
    ...
    body: "$25/month turns Keycove into your full landlord operating system — and your first month includes a free professional website, custom logo, and Year 1 domain built by Certify Business Pro.",
    points: [
