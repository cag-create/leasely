...
const FREE_FEATURES = [
  ...
  { label: "Background checks (TransUnion)", included: false },
...
const PRO_FEATURES = [
  ...
  { label: "Background checks (TransUnion SmartMove)", included: true },
...
const COMPARISON_ROWS = [
  ...
  { category: "Screening", label: "Background checks (TransUnion)", free: false, pro: true },
