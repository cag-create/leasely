...
const FREE_FEATURES = [
  ...
  { label: "Branded portal (keycove.net/portal/yourname)", included: false },
...
const PRO_FEATURES = [
  ...
  { label: "Branded portal (keycove.net/portal/yourname)", included: true },
...
const COMPARISON_ROWS = [
  ...
  { category: "Portal", label: "Branded portal (keycove.net/portal/yourname)", free: false, pro: true },
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "When you upgrade to Pro, you choose a subdomain (e.g., 'smithproperties') and your portal becomes live at keycove.net/portal/smithproperties. You can share this URL on Google Business, Zillow, social media, or print it on business cards. It shows your logo, brand colors, and all your active listings."
  },
  {
  ...
  },
  {
    ...
    a: "No. Pro is $25/month flat — no per-property or per-unit fees, ever. List 1 property or 100. Add a property manager. Hand off entire portfolios. It's all the same $25/month."
  },
  {
          ...
          <div className="rounded-3xl border-2 p-8 relative overflow-hidden" style={{ borderColor: ACCENT, background: `linear-gradient(160deg, ${BRAND} 0%, #3A2410 100%)` }}>
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-1.5 mt-1">
                <span className="text-white/70 text-sm font-semibold">first month includes a free website, logo & domain</span>
              </div>
              ...
              <>
                <label className="flex items-start gap-2.5 mb-4 bg-white/5 border border-white/10 rounded-xl p-3 cursor-pointer hover:bg-white/10 transition-colors">
                  ...
                  <span className="text-xs text-white/65 leading-relaxed">
                    I agree: <strong className="text-white">first month covers website production and is non-refundable once design begins</strong> (work starts immediately, delivered in 24–48 hours). $25/mo cancellable anytime, no pro-rated refunds. I keep my website &amp; logo regardless. <Link href="/terms" className="underline hover:text-white" target="_blank">Terms</Link> ·{" "}
            ...
            <p className="text-white/40 text-xs text-center mt-6">$25/mo — first month includes a free website, logo & keycove.net URL · Cancel anytime</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                desc: "Your own keycove.net/portal/yourname portal looks professional and builds trust with prospective tenants on Google.",
              },
              {
                icon: Wrench,
                color: "#FEF3C7",
      ...
      <section className="py-20 px-4 text-center" style={{ background: `linear-gradient(135deg, ${BRAND}, #3A2410)` }}>
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-white/40 text-sm mt-6">
            Free tier · No credit card required · Pro: $25/mo · Cancel anytime
          </p>
      ...
      <div className="py-10 px-4 bg-background border-t border-border">
        <div className="max-w-3xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 rounded-2xl bg-gradient-to-r from-[#4F46E5]/8 to-[#4F46E5]/8 border border-[#4F46E5]/15 px-8 py-6">
          <div className="text-center md:text-left">
            ...
            <p className="text-muted-foreground text-sm mt-1">No cap, no expiry. Earn a $50 one-time bonus for every landlord who signs up using your affiliate code and pays their first full month.</p>
          </div>
