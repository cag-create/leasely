...
const FREE_FEATURES = [
  ...
  { label: "Branded portal (leasely.net/portal/yourname)", included: false },
...
const PRO_FEATURES = [
  ...
  { label: "Branded portal (leasely.net/portal/yourname)", included: true },
...
const COMPARISON_ROWS = [
  ...
  { category: "Portal", label: "Branded portal (leasely.net/portal/yourname)", free: false, pro: true },
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                desc: "Your own leasely.net/portal/yourname portal looks professional and builds trust with prospective tenants on Google.",
              },
              {
                icon: Wrench,
                color: "#FEF3C7",
