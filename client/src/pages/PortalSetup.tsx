            ...
            <div className="rounded-xl border border-white/10 bg-white/[0.03] p-5 space-y-4">
              ...
              {(user as any)?.role !== "admin" && (
                <p className="text-xs text-white/40 pt-1 border-t border-white/5">
                  Keycove charges <span className="text-white/60 font-semibold">$25 one-time setup + $29/mo</span>. Everything else above is between you and CBP — no markups, no kickbacks.
                </p>
              )}
            </div>
