  ...
  const sections = useMemo<Section[]>(() => [
    {
      ...
      icon: Sparkles,
      intro: "Your $25/month unlocks everything below.",
      body: (
      ...
      body: (
        <ol className="space-y-3">
          {[
            ...
            { path: "/pro-setup", label: "Start Pro — $25/mo", desc: "Your portal subdomain is provisioned automatically within ~30 seconds." },
