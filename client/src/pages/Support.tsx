...
const FAQ_CATEGORIES = [
  ...
  },
  {
    ...
    bg: "bg-green-50",
    questions: [
      { q: "What does the Pro plan cost?", a: "The Pro plan is $25/month, cancel anytime. Your first month includes a free branded website, custom logo, and personalized keycove.net URL. It also includes unlimited listings, your own branded portal, AI tenant screening, fraud detection, rental applications, Stripe Connect payouts, waived ACH fees, and priority customer support." },
