...
const FAQ_CATEGORIES = [
  ...
  },
  {
    ...
    bg: "bg-green-50",
    questions: [
      { q: "What does the Pro plan cost?", a: "The Pro plan is a $25 one-time setup fee plus $25/month. The setup fee includes your branded website, custom logo placement, and your personalized keycove.net subdomain URL. It also includes unlimited listings, your own branded portal, AI tenant screening, fraud detection, rental applications, Stripe Connect payouts, waived ACH fees, and priority customer support." },
