...
export default function Terms() {
  return (
    <LegalLayout title="Terms of Service" effectiveDate="April 25, 2026">
      <p>
        These Terms of Service ("Terms") govern your access to and use of the Leasely platform, marketing site, and related services (the "Services") provided by Leasely, Inc. ("Leasely," "we," "us"). By creating an account, listing a property, submitting an application, signing a lease, or otherwise using the Services, you agree to these Terms.
      </p>
      ...
      <LegalSection title="7. Intellectual Property">
        <p>Leasely and its licensors own all right, title, and interest in the Services, including all software, design, branding, and content (excluding User Content). We grant you a limited, non-exclusive, non-transferable, revocable license to use the Services solely as permitted by these Terms.</p>
        <p><strong className="text-white">Your Content:</strong> You retain ownership of content you submit (listings, photos, lease text, etc.). You grant Leasely a worldwide, non-exclusive, royalty-free license to host, display, and distribute your content as necessary to operate the Services.</p>
      </LegalSection>
      ...
      <LegalSection title="9. Disclaimers">
        <p className="uppercase text-xs text-white/50 tracking-wide">The Services are provided "as is" and "as available" without warranties of any kind, whether express or implied, including merchantability, fitness for a particular purpose, non-infringement, or quiet enjoyment. Leasely does not guarantee that listings will be filled, applications will be approved, payments will succeed, or that the Services will be uninterrupted or error-free.</p>
      </LegalSection>

      <LegalSection title="10. Limitation of Liability">
        <p className="uppercase text-xs text-white/50 tracking-wide">To the maximum extent permitted by law, Leasely's total liability for any claim arising out of or related to the Services shall not exceed the greater of (a) the amount you paid Leasely in the twelve months preceding the claim or (b) one hundred U.S. dollars ($100). In no event shall Leasely be liable for indirect, incidental, special, consequential, exemplary, or punitive damages, including lost profits, lost data, or business interruption.</p>
      </LegalSection>

      <LegalSection title="11. Indemnification">
        <p>You agree to defend, indemnify, and hold harmless Leasely and its officers, directors, employees, and agents from and against any claims, damages, liabilities, costs, and expenses (including reasonable attorneys' fees) arising from (a) your use of the Services, (b) your violation of these Terms or applicable law, (c) your User Content, or (d) any dispute between you and another user.</p>
      </LegalSection>
      ...
      <LegalSection title="16. Contact">
        <p>Leasely, Inc. — <a href="mailto:support@leasely.net" className="text-[#4F46E5] hover:underline">support@leasely.net</a></p>
      </LegalSection>
    </LegalLayout>
  );
}
